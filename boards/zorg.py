...
hw = [
    Button(pin=32, name='a_button', pull_up=True, can_id=50, callback=iris.button_sender),
    Button(pin=26, name='b_button', pull_up=True, can_id=51, callback=iris.button_sender),
    Button(pin=19, name='c_button', pull_up=True, can_id=52, callback=iris.button_sender),
    Button(pin=23, name='d_button', pull_up=True, can_id=53, callback=iris.button_sender)
    ]
